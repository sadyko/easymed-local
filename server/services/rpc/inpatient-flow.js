...
const ROLE_TITLE = {
  ...
  lab: 'лаборант',
  inventory: 'склад',
  // CALLCENTER_OPERATOR_V1 — роль зовётся ЧЕЛОВЕКОМ, как и везде («Настройки →
  // Роли», карточка сотрудника, отделы, role-reach.js ROLE_WORD). Отказ
  // перечисляет профессии — «это делает: медсестра, врач», — и «колл-центр»
  // читался в этом ряду отделом, а не тем, к кому идти.
  callcenter: 'оператор колл-центра',
};
