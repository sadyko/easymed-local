...
export const TABLES = [
  ...
  },
  {
    ...
    columns: [
      ...
      // DOCTOR_TIER_V2 (миграция 147) — ступени 2 и 3 едут так же.
      'doctor_tier_from_2', 'doctor_tier_percent_2', 'doctor_tier_from_3', 'doctor_tier_percent_3',
      // EXTERNAL_LAB_V1 (миграция 147) — «Внешняя лаборатория»: свойство услуги
      // клиники (кто делает анализ), а не здания.
      'external_lab',
