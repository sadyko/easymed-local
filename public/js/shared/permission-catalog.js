...
export const CATALOG = [
  ...
  { key: 'settings',    label: 'Настройки',           legacy: 'settings', desc: 'Вся конфигурация клиники: услуги, сотрудники, роли, телефония.', levels: ['none', 'view', 'edit'], levelDesc: { view: 'Открывает настройки с теми разделами, что отмечены ниже.', edit: 'Открывает настройки; менять можно разделы, выданные на «Изменение».' }, windows: [
      ...
      { key: 'settings.service_types', group: 'Настройки услуг', label: 'Типы услуг', desc: 'Как услуги сгруппированы в прайсе.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Заводит и правит типы услуг.' }, legacyKeys: 'hub', enforced: 'db:service_types' },
      { key: 'settings.consultation_types', group: 'Настройки услуг', label: 'Консультации врачей', desc: 'Виды консультаций и их стоимость.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Заводит и правит виды консультаций.' }, legacyKeys: 'hub', enforced: 'db:consultation_types' },
      ...
      { key: 'settings.patient_categories', group: 'Основное', label: 'Категории пациентов', desc: 'Группы пациентов и скидка каждой группы.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Заводит и правит категории и их скидки.' }, legacyKeys: 'hub', enforced: 'db:patient_categories' },
      ...
      { key: 'settings.patient_discounts', group: 'Основное', label: 'Скидки пациентов', desc: 'Промокоды и сертификаты: срок, группа пациентов, услуги.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Заводит и правит скидки.' }, legacyKeys: 'hub', enforced: 'db:patient_discounts' },
      ...
      { key: 'settings.company', group: 'Настройки Easy-Med', label: 'Компания', desc: 'Название, логотип, фирменный цвет и контакты клиники.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Меняет название, логотип и контакты клиники.' }, legacyKeys: ['documents-settings', 'documents', 'settings'], enforced: 'db:doc_settings' },
      ...
      { key: 'settings.rooms', group: 'Помещения', label: 'Помещения', desc: 'Этажи, кабинеты и палаты: койки, цены, оборудование.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Заводит и правит этажи, кабинеты, палаты, койки и оборудование. Удаляет и назначает врачей — администратор.' }, legacyKeys: ['rooms-setup', 'settings:rooms', 'settings:wards', 'settings:beds_settings', 'settings:floors', 'settings'], enforced: 'db:rooms' },
      ...
      { key: 'settings.payer_policies', group: 'Управление плательщиками', label: 'Страховые полисы', desc: 'Что и на сколько процентов покрывает каждый плательщик.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Заводит и правит полисы.' }, legacyKeys: 'hub', enforced: 'db:payer_policies' },
      { key: 'settings.payment_providers', group: 'Управление плательщиками', label: 'Провайдеры онлайн-платежей', desc: 'Какую комиссию платит клиника.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Заводит и правит провайдеров.' }, legacyKeys: 'hub', enforced: 'db:payment_providers' },
      { key: 'settings.cashback_rules', group: 'Управление плательщиками', label: 'Кэшбэк', desc: 'Сколько возвращать пациенту и за что.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Заводит и правит правила кэшбэка.' }, legacyKeys: 'hub', enforced: 'db:cashback_rules' },
      { key: 'settings.referral_sources', group: 'Направления', label: 'Список источников', desc: 'Откуда приходят пациенты.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Заводит и правит источники и их ставки.' }, legacyKeys: 'hub', enforced: 'db:referral_sources' },
      { key: 'settings.referral_source_categories', group: 'Направления', label: 'Категории источников', desc: 'Как сгруппированы источники.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Заводит и правит категории и стандартные ставки.' }, legacyKeys: 'hub', enforced: 'db:referral_source_categories' },
      { key: 'settings.doctor_rates', group: 'Зарплата врача', label: 'Ставки врачей', desc: 'Процент врача по каждой услуге.', levels: ['none', 'view', 'edit'], levelDesc: { edit: 'Меняет процент врача по услуге.' }, legacyKeys: 'hub', enforced: 'db:doctor_rates' },
    ], actions: [] },
];
