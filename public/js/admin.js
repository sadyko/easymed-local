...
import { renderRoomsSetup } from './admin/views/rooms-setup.js?v=rooms5';   // ROOMS_SETUP_V1 — кабинеты и палаты одним разделом
...
import { renderSettingsHub }  from './admin/views/settings-hub.js?v=rooms3';   // SETTINGS_HUB_V1 — Документы -> rich designer; Пациенты -> settings:patients route
