...
import { renderLaboratory }   from './admin/views/laboratory.js?v=labhead1';   // LAB_HEAD_ONE_V1 — one shared head for queue+panels, marker → data-attr, uz-safe filter chips
