...
const FAIL_NOTE = {
  ...
  not_installed:    'Эта установка не может обновляться: она разложена неправильно. Обратитесь в Easy-Med — систему нужно переустановить официальным пакетом, данные при этом сохраняются.',
};
