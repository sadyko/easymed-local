...
"public/js/admin/auth.js | users | column \"license_number\"",
  ...
  "public/js/admin/data.js | invoices | filter \"created_at\"",
  "public/js/admin/data.js | invoices | filter \"created_by\"",
  "public/js/admin/data.js | patient_allergies | table",
  "public/js/admin/data.js | visit_services | filter \"created_by\"",
  "public/js/admin/setup-checklist.js | branches | column \"created_at\"",
  ...
  "public/js/admin/setup-checklist.js | branches | order \"created_at\"",
  ...
  "public/js/admin/views/consultation.js | invoice_items | column \"invoices(status)\"",
  "public/js/admin/views/consultation.js | recommended_services | column \"services(name, price, tax_rate, type_id, category_id, service_categories(name), service_types(name))\"",
  "public/js/admin/views/docs-archive.js | visits | column \"users:doctor_id(full_name)\"",
  ...
  "public/js/admin/views/invoice-actions.js | payments | filter \"notes\"",
  ...
  "public/js/admin/views/items-ledger.js | stock_movements | column \"branch_id\"",
  "public/js/admin/views/items-ledger.js | stock_movements | column \"item_id\"",
  "public/js/admin/views/items-ledger.js | stock_movements | filter \"unit_cost\"",
  ...
  "public/js/admin/views/pharmacy.js | visit_services | column \"visits!inner(patient_id, patients(full_name, last_name, first_name))\"",
  "public/js/admin/views/pharmacy.js | visit_services | filter \"clinic_item_id\"",
  "public/js/admin/views/procedures.js | visit_services | filter \"clinic_item_id\"",
  ...
  "public/js/admin/views/procurement.js | stock_movements | column \"users:created_by(full_name)\"",
  "public/js/admin/views/procurement.js | stock_movements | filter \"created_at\"",
  ...
  "public/js/admin/views/procurement.js | stock_movements | filter \"qty\"",
  "public/js/admin/views/procurement.js | stock_movements | filter \"unit_cost\"",
  "public/js/admin/views/referral-settings.js | companies | column \"referral_reward_rates\"",
  "public/js/admin/views/reports-export.js | admission_services | filter \"clinic_item_id\"",
  ...
  "public/js/admin/views/reports-export.js | invoice_items | column \"invoices!inner ( id, invoice_number, admission_id, patient_id, branch_id, created_at, patients ( id, mrn, full_name ) )\"",
  ...
  "public/js/admin/views/reports-export.js | invoice_items | column \"services ( id, name, type, tax_rate, default_doctor_percent, category_id, type_id )\"",
  "public/js/admin/views/reports-export.js | invoice_items | column \"services ( id, name, type, tax_rate, default_doctor_percent, type_id )\"",
  "public/js/admin/views/reports-export.js | invoice_items | filter \"invoices.created_at\"",
  "public/js/admin/views/reports-export.js | invoices | column \"branches ( name )\"",
  "public/js/admin/views/reports-export.js | invoices | column \"coverage_type\"",
  "public/js/admin/views/reports-export.js | invoices | column \"patients ( full_name, mrn, phone )\"",
  "public/js/admin/views/reports-export.js | invoices | filter \"created_at\"",
  ...
  "public/js/admin/views/reports-export.js | purchase_order_items | filter \"purchase_orders.created_at\"",
  ...
  "public/js/admin/views/reports-export.js | visit_services | filter \"visits.visit_date\"",
  ...
  "public/js/admin/views/requests-inbox.js | visits | filter \"notes\"",
  "public/js/admin/views/section-crud.js | services | column \"core_service_id\"",
  "public/js/admin/views/section-crud.js | users | filter \"room_id\"",
  "public/js/admin/views/section-import-export.js | branches | order \"created_at\"",
  ...
  "public/js/admin/views/section-import-export.js | stock_movements | filter \"reference_type\"",
  ...
  "public/js/admin/views/service-workspace.js | visit_services | column \"services(name, code, type_id, service_types(name), departments(kind))\"",
  "public/js/admin/views/service-workspace.js | visit_services | column \"visits!inner(visit_date, patient_id)\"",
  "public/js/admin/views/service-workspace.js | visit_services | filter \"clinic_item_id\"",
  "public/js/admin/views/service-workspace.js | visit_services | filter \"visits.patient_id\"",
  "public/js/admin/views/visit-modal.js | invoice_audit_log | column \"users:actor_user_id(full_name, role)\"",
  "public/js/admin/views/visit-modal.js | patients | column \"behavior_note\"",
  "public/js/admin/views/visit-modal.js | patients | column \"creator:created_by(full_name)\"",
  "public/js/admin/views/visit-modal.js | referral_sources | column \"category_id\"",
  "public/js/admin/views/visit-modal.js | visit_services | column \"creator:created_by(full_name)\"",
]);
