...
test('печать: шапка клиники, номер истории, три блока, подпись медсестры', async () => {
    ...
    // FORM_003_V1 — бланк 003: шапка министерства, учреждение, приказ № 363 (2020), заголовок с номером.
    for (const piece of ['Клиника Тест', 'ООО Тест', 'ул. Мира 1', 'Соғлиқни сақлаш вазирлиги', '363-сонли', '2020 йил 31 декабрдаги', 'БЕМОРНИНГ ТИББИЙ БАЁННОМАСИ', 'H-7', 'Титульный лист',
