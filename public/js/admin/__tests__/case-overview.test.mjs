...
test('блоки: статус, диагноз, состояние, стол, назначения, услуги, операция, счёт, история, выписка', async () => {
    ...
    const t = textOf(root);
    for (const piece of ['Статус', 'K35.8', 'Острый аппендицит', '36.6', '120/80', 'Стол №1', 'съедено 2', 'отказ 1',
        'Цефтриаксон', 'введено 2', 'назначено 4', 'пропущено 1', 'Аппендэктомия', '900 000', 'не выставлено',
        'Запланирована', 'Койко-дней', '300 000', '3 из 9', 'Просрочено', 'Обоснование клинического диагноза', 'не подана']) {
