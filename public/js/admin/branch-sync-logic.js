 ...
 *   'not_main'  — ключи выдаёт главный филиал, а эта установка не он;
...
export function branchRows(status) {
  ...
  const isMain = !!(status && status.role === 'main');
  return list.map((b) => {
...
const BRANCH_ROW_NOTES = {
  ...
  not_main: 'Ключи филиалам выдаёт главный филиал — возьмите ключ там.',
